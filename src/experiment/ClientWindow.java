...
public class ClientWindow extends Shell {
	...
	public ClientWindow(Display display, DataAccess dataAccess, Client client) {
		...
		fd_text_6.right = new FormAttachment(text_8, 0, SWT.RIGHT);
		fd_text_6.top = new FormAttachment(label_1, 7);
		...
		fd_text_7.top = new FormAttachment(0, 148);
		...
		fd_text_8.right = new FormAttachment(lblPhonework, 127, SWT.RIGHT);
		fd_text_8.bottom = new FormAttachment(lblPhonehome, 0, SWT.BOTTOM);
		fd_text_8.left = new FormAttachment(lblPhonework, 6);
		...
		fd_text_9.right = new FormAttachment(btnCheckButton_2, 0, SWT.RIGHT);
		fd_text_9.top = new FormAttachment(lblNewLabel_1, 16);
		fd_text_9.left = new FormAttachment(lblName, 0, SWT.LEFT);
