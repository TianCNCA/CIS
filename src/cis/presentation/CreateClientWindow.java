...
public class CreateClientWindow 
{
	...
	public void open() {
		...
		lblNewLabel
				.setText("Out of the following list, check all that apply to you");
		...
		lblListAnySportexercisehobbies
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseUp(MouseEvent arg0) {
				...
				DateFormat dateFormat = new SimpleDateFormat(
						"yyyy/MM/dd HH:mm:ss");
				Date date = new Date();
				client.setDOB(dateFormat.format(date)); // fake date
